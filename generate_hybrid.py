...
=======
    ...
    "n_layers": [5, 3,1],
    #"seed": [1924, 1925, 1926]
    "seed": [2024, 1973, 1926, 1925, 1924]#[1924, 1925, 1926, 1973, 2024]#2025, 2024], 2012, 1958, 1962, 1997]
>>>>>>> 908abb6e65d437b4d78839f084a5860d27ba5d98
}
...
headers_written = {
    ...
    SUMMARY_CHYBRID_PATH: os.path.exists(SUMMARY_CHYBRID_PATH),
    ...
    try:
        if model_type == "HQNN": 
            ...
            if model_class == "MLP":
                ...
                model_c = MLP(hidden=config['hidden'], blocks=config['blocks'], device=device,
                        activation=config['activation'])
        
            elif model_class == "ResNet":
                model_c = ResNet(hidden=config['hidden'], blocks=config['blocks'], device=device,
                            activation=config['activation'])
